...
//        composeTestRule.waitUntilNodeCount(hasText("Wea", true), 1)
        composeTestRule.waitUntilNodeCount(hasText("Sun", substring = true, ignoreCase = true),1, 10000)

//        composeTestRule.onNode(hasText("°C")).assertExists()
    }
